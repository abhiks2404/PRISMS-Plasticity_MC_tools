# PRISMS-PF_MC_tools
**Tools for integration between PRISMS-Plasticity and Materials Commons**

The script files in this repository can be used to assist with automation of the following tasks:
- Locally importing PRISMS-Plasticity code files and simulation results into a Materials Commons project directory
